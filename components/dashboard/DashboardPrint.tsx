  ...
  return (
    <div className="p-6 sm:p-8 space-y-6">
      ...
      <div className="bg-blue-600 rounded p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <p className="text-white font-semibold text-lg">Ready to order prints?</p>
          <p className="text-blue-100 text-sm mt-0.5">Generate print-ready PDFs for your branded materials.</p>
        </div>
        <Link
          href="/dashboard/print"
      ...
      {/* Products */}
      <div>
        <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-3">Available Products</p>
      ...
      <div className="bg-white border border-gray-200 rounded p-5 flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">Keep your logo, colors, and company info up to date so all prints stay current.</p>
        </div>
        <Link
